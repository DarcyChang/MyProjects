...
*** Variables ***
*** Test Cases ***
tc_SPI_Firewall_with_block_LAND_attack
    [Documentation]  tc_SPI_Firewall_with_block_LAND_attack
    ...    1. Setup WAN host and connected DUT WAN side.
    ...    2. WAN host simulate LAND attack to LAN host and DUT can block this attack.

    [Tags]   @TCID=WRTM-326ACN-297    @DUT=WRTM-326ACN     @AUTHOR=Jujung_Chang
    [Timeout]

    Setup WAN host and connected DUT WAN side
    WAN host simulate LAND attack to LAN host and DUT can block this attack
