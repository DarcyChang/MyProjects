...
*** Test Cases ***
tc_Security_set_to_WPA2_PSK_Config_Password_with_invalid_value
    [Documentation]  tc_Security_set_to_WPA2_PSK_Config_Password_with_invalid_value
    ...    1. Go to web page Networking>Wireless and set Security to WPA2-PSK
    ...
    [Tags]   @TCID=WRTM-326ACN-310    @DUT=WRTM-326ACN     @AUTHOR=Jujung_Chang
    [Timeout]

    Go to web page Networking>Wireless and set Security to WPA2-PSK
