...
${MTU_Maximum}    1472
*** Test Cases ***
tc_Static_mode_MTU_function
    [Documentation]  tc_Static_mode_MTU_function
    ...
    ...    6. In MTU Auto mode, ping 1472 bytes packet from LAN to WAN side PC check the packet size is 1472 bytes on DUT WAN side.
    [Tags]   @TCID=WRTM-326ACN-296    @DUT=WRTM-326ACN     @AUTHOR=Jujung_Chang
    [Timeout]
