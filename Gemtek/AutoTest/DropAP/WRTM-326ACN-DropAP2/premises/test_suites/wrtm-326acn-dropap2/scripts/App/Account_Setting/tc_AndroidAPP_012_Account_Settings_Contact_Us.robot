...
*** Test Cases ***
tc_AndroidAPP_012_Account_Settings_Contact_Us
    [Documentation]  tc_AndroidAPP_012_Account_Settings_Contact_Us
    ...    1. Launch the app and into the main page.
    ...    2. Press account settings at left-upper corner.
    ...    3. Press Contact Us.
    ...    4. Check the status.
    [Tags]   @TCID=WRTM-326ACN-206    @DUT=WRTM-326ACN     @AUTHOR=Leo_Li
    [Timeout]
