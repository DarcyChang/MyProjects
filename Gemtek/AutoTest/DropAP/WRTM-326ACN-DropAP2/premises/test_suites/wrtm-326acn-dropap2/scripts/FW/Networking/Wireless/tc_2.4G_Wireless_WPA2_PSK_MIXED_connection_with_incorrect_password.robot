...
*** Test Cases ***
tc_2.4G_Wireless_WPA2_PSK_MIXED_connection_with_incorrect_password
    [Documentation]  tc_2.4G_Wireless_WPA2_PSK_MIXED_connection_with_incorrect_password
    ...
    [Tags]   @TCID=WRTM-326ACN-413    @DUT=WRTM-326ACN     @AUTHOR=Hans_Sun
    [Timeout]
...
2.4GWIFI client using inconnect password to associate with DUT and verify client can't send traffic to the DUT successfully
    ...
    #Verify Wifi Client On Wireless Status GUI    ${Table_hostname}    ${DEVICES.wifi_client.hostname}
