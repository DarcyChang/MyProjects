...
*** Test Cases ***
tc_5G_Wireless_Security_Type_Is_WPA2_PSK_connection
    [Documentation]  tc_5G_Wireless_Security_Type_Is_WPA2_PSK_connection
    ...
    [Tags]   @TCID=WRTM-326ACN-462    @DUT=WRTM-326ACN     @AUTHOR=Hans_Sun
    [Timeout]
