...
*** Test Cases ***
tc_2.4G_Wireless_WEP_connection_with_incorrect_passward
    [Documentation]  tc_2.4G_Wireless_WEP_connection_with_incorrect_passward
    ...
    [Tags]   @TCID=WRTM-326ACN-412    @DUT=WRTM-326ACN     @AUTHOR=Hans_Sun
    [Timeout]
