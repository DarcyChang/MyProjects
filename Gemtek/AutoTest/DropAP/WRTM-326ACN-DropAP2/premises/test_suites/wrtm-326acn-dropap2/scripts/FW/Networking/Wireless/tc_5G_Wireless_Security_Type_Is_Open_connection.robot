...
*** Test Cases ***
tc_5G_Wireless_Security_Type_Is_Open_connection
    [Documentation]  tc_5G_Wireless_Security_Type_Is_Open_connection
    ...
    [Tags]   @TCID=WRTM-326ACN-464    @DUT=WRTM-326ACN     @AUTHOR=Hans_Sun
    [Timeout]
