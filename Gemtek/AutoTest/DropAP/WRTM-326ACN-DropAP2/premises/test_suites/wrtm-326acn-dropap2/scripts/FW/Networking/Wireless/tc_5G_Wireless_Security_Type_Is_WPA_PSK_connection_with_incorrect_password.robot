...
*** Test Cases ***
tc_5G_Wireless_Security_Type_Is_WPA_PSK_connection_with_incorrect_password
    [Documentation]  tc_5G_Wireless_Security_Type_Is_WPA_PSK_connection_with_incorrect_password
    ...
    [Tags]   @TCID=WRTM-326ACN-461    @DUT=WRTM-326ACN     @AUTHOR=Hans_Sun
    [Timeout]
