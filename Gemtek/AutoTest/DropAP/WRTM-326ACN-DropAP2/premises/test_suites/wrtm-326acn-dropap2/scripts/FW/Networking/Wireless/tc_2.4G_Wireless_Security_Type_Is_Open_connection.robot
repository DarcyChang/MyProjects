...
*** Test Cases ***
tc_2.4G_Wireless_Security_Type_Is_Open_connection
    [Documentation]  tc_2.4G_Wireless_Security_Type_Is_Open_connection
    ...
    [Tags]   @TCID=WRTM-326ACN-459    @DUT=WRTM-326ACN     @AUTHOR=Hans_Sun
    [Timeout]
