...
*** Test Cases ***
tc_2.4G_Interface_Configuration_SSID
    [Documentation]  tc_2.4G_Interface_Configuration_SSID
    ...
    [Tags]   @TCID=WRTM-326ACN-402    @DUT=WRTM-326ACN     @AUTHOR=Hans_Sun
    [Timeout]
...
Verify wireless client can associate to DUT or not
    ...
    [Tags]   @AUTHOR=Hans_Sun
    Wait Until Keyword Succeeds    3x    1s    Login Linux Wifi Client To Connect To DUT Without Security Key    wifi_client    ${ssid_test1}    ${DEVICES.wifi_client.int}    ${g_dut_gw}
...
Verify wireless client can associate to DUT or not again
    [Documentation]  Verify wireless client can associate to DUT or not
    [Tags]   @AUTHOR=Hans_Sun
    Wait Until Keyword Succeeds    3x    1s    Login Linux Wifi Client To Connect To DUT Without Security Key    wifi_client    ${ssid_test2}    ${DEVICES.wifi_client.int}    ${g_dut_gw}
