...
*** Test Cases ***
tc_SPI_Firewall_with_block_Black_Nurse_attack
    [Documentation]  tc_SPI_Firewall_with_block_Black_Nurse_attack
    ...    1. Setup WAN host and connected DUT WAN side.
    ...    2. WAN host simulate Black Nurse attack to DUT WAN IP and DUT can block this attack
    [Tags]   @TCID=WRTM-326ACN-360    @DUT=WRTM-326ACN     @AUTHOR=Hans_Sun
    [Timeout]

    Setup WAN host and connected DUT WAN side
    WAN host simulate SYN Black Nurse to DUT WAN IP and DUT can block this attack
