...
MAIN_TREE="1.2.0-KENYA";
MAIN_VERSION="1.2.22-KENYA";

SCRIPT_PATH="/home/darcy/intel";
SDK_PATH="/home/darcy/intel/release/$MAIN_TREE";
SDK_ENABLE_ROOT_FILE_PATH="/home/darcy/intel/release/enable_root";
SDK_DISABLE_ROOT_FILE_PATH="/home/darcy/intel/release/disable_root";
FIRMWARE_VERSION="$MAIN_VERSION";

SVN_BRANCH_PATH="http://10.5.88.14/EasyConnect/branch/release"/$MAIN_TREE ;
SVN_USER="darcy_chang" ;
SVN_PASSWD="darcychang" ;
...
#svn log $SDK_PATH > $AUTO_BUILD_PATH/releaseLog
...
#	echo $FIRMWARE_VERSION-rooted > $SDK_PATH/etc/version
	echo $FIRMWARE_VERSION-JPIK > $SDK_PATH/etc/version
	cd $SDK_PATH
...
#		cp -f output/package_release.tgz $AUTO_BUILD_PATH/package_"$FIRMWARE_VERSION"_rooted.tgz
		cp -f output/package_release.tgz $AUTO_BUILD_PATH/package_"$FIRMWARE_VERSION"_JPIK.tgz
	else
		PRINT "Build ERROR";
		exit 0;
	fi
...
cp $AUTO_BUILD_PATH/package_$FIRMWARE_VERSION.tgz /home/ftpuser/$MAIN_TREE/JPIK/$FIRMWARE_VERSION
cp $AUTO_BUILD_PATH/package_"$FIRMWARE_VERSION"_JPIK.tgz /home/ftpuser/$MAIN_TREE/JPIK/$FIRMWARE_VERSION
cp $AUTO_BUILD_PATH/md5_txt /home/ftpuser/$MAIN_TREE/JPIK/$FIRMWARE_VERSION
