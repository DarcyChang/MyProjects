...
cd /home/evans_lai/projects/WRTR-300ACN324CN/autobuild
...
cp -dpf $PROJECT_ROOT/bin/ramips/openwrt-ramips-mt7620a-wrtr-300acn-squashfs-sysupgrade.bin $AUTOBUILD_ROOT/firmware.img
