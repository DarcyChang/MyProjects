#include <diag_cmm.h>
#include "battery.h"
#include "battery_com.cc"
#include "show_rel_charge.cc"
#include "show_abs_charge.cc"
#include "show_battery_status.cc"
#include "show_charge_current.cc"
...
DIAG_CODE battery_utils(IO_DATA *pio_data, DIAG_RESULT *prst)
{
	...
	DIAGS_NODE *menu = diag_basic_battery_menu;

	diag_menu_index_init(menu, SIZE_BATTERY_MENU);

	while (1) {
		flag_valid_menu = UNSET;
		show_menu(menu, SIZE_BATTERY_MENU, pio_data);
