#include <diag_cmm.h>
#include "cloud.h"
#include "cloud_com.cc"
#include "set_cloud_pincode.cc"
#include "get_cloud_pincode.cc"
...
DIAG_CODE cloud_utils(IO_DATA *pio_data, DIAG_RESULT *prst)
{
	...
	DIAGS_NODE *menu = diag_basic_cloud_menu;

	diag_menu_index_init(menu, SIZE_CLOUD_MENU);

	while (1) {
		flag_valid_menu = UNSET;
		show_menu(menu, SIZE_CLOUD_MENU, pio_data);
