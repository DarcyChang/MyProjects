...
DIAG_CODE sdc_utils(IO_DATA *pio_data, DIAG_RESULT *prst)
{
	...
	DIAGS_NODE *menu = diag_basic_sdc_menu;

	diag_menu_index_init(menu, SIZE_SDC_MENU);

	while (1) {
		flag_valid_menu = UNSET;
		show_menu(menu, SIZE_SDC_MENU, pio_data);
