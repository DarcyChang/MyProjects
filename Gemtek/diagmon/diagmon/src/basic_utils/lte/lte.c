...
#include "lte.h"
#include "lte_com.cc"
#include "show_lte_info.cc"
#include "show_lte_imei_info.cc"
#include "show_lte_rssi_info.cc"
...
DIAG_CODE lte_utils(IO_DATA *pio_data, DIAG_RESULT *prst)
{
	...
	DIAGS_NODE *menu = diag_basic_lte_menu;

	diag_menu_index_init(menu, SIZE_LTE_MENU);

	while (1) {
		flag_valid_menu = UNSET;
		show_menu(menu, SIZE_LTE_MENU, pio_data);
