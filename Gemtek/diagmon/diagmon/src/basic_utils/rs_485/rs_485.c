#include <diag_cmm.h>
#include "rs_485.h"
#include "rs_485_com.cc"
#include "rs_485_send_test_signal.cc"
#include "rs_485_enter_receive_mode.cc"
...
DIAG_CODE rs_485_utils(IO_DATA *pio_data, DIAG_RESULT *prst)
{
	...
	DIAGS_NODE *menu = diag_basic_rs_485_menu;

	diag_menu_index_init(menu, SIZE_RS_485_MENU);

	while (1) {
		flag_valid_menu = UNSET;
		show_menu(menu, SIZE_RS_485_MENU, pio_data);
